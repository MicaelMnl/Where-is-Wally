...
import UIKit
import Foundation
class MediumViewController: UIViewController , UIScrollViewDelegate{
    
    @IBOutlet var scrollView: UIScrollView!
    let imageView = UIImageView(image: UIImage(named: "bck-m.jpg")!)
    ...
    override func viewDidLoad() {
        ...
        timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(MediumViewController.action), userInfo: nil, repeats: true)
        ...
        for i in 0...2 {
            ...
            button.addTarget(self, action: #selector(MediumViewController.clicked), for: .touchUpInside)
            ...
            if(!arrayCharlie.checkCharlie()){
               ...
               timer.invalidate()
                ...
                alert.addAction(UIAlertAction(title: "END", style: .default, handler: { [weak alert] (_) in
                    ...
                    self.score.setHighMedium(score: self.time, message: "\(name):\(self.time)", courrentHightScore : self.score.findMediumScore())
